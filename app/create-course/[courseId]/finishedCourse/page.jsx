...
const FinishScreen = ({ params }) => {
  ...
  //fn call to get the new course layout been created
  ...
  return (
    <div className="px-10 md:px-20 lg:px-44 my-7">
      <h2 className="text-center font-bold text-2xl my-3 text-violet-500">
        Congrats, Your course is ready!!
      </h2>

      {/* as our course is now ready, just doing as to show the previous build courseinfo, just to show its ready , done without edit, hence be stable*/}
      <CourseBasicInfo course={course} refreshData={() => console.log()} />

      {/*******  VV IMP******* : we are doing here as crearting the link of the chapter to pass to someone for viewing. */}
